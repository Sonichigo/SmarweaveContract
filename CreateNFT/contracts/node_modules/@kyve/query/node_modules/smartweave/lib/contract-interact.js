...
function interactWriteDryRun(arweave, wallet, contractId, input, tags = [], target = '', winstonQty = '', myState, fromParam, contractInfoParam) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let { handler, swGlobal, contractSrcTXID } = contractInfoParam || (yield contract_load_1.loadContract(arweave, contractId));
...
function interactRead(arweave, wallet, contractId, input, tags = [], target = '', winstonQty = '') {
    return __awaiter(this, void 0, void 0, function* () {
        // tslint:disable-next-line: prefer-const
        let { handler, swGlobal, contractSrcTXID } = yield contract_load_1.loadContract(arweave, contractId);
