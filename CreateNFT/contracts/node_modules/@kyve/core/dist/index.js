...
var KYVE = /** @class */ (function () {
    ...
    KYVE.prototype.listener = function () {
        ...
        return new rxjs_1.Observable(function (subscriber) {
            ...
            var main = function (address) { return __awaiter(_this, void 0, void 0, function () {
                var state, newHash, unhandledTxs, _i, unhandledTxs_1, id, res, node, data, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 10];
                        case 2: return [4 /*yield*/, this.pool.getUnhandledTxs(address)];
                        case 3:
                            unhandledTxs = _a.sent();
                            _i = 0, unhandledTxs_1 = unhandledTxs;
                            _a.label = 4;
                        case 4:
                            if (!(_i < unhandledTxs_1.length)) return [3 /*break*/, 10];
                            id = unhandledTxs_1[_i];
    ...
    KYVE.prototype.uploader = function (dryRun) {
        ...
        var node = new rxjs_1.Observable(function (subscriber) {
            return _this.uploadFunc(subscriber, _this.poolID, _this.pool.state.config);
        });
    ...
    KYVE.prototype.validator = function () {
        var _this = this;
        var node = new rxjs_1.Observable(function (subscriber) {
            return _this.validateFunc(_this.listener(), subscriber, _this.poolID, _this.pool.state.config);
        });
