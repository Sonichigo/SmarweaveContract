...
export declare type UploadFunction = (subscriber: UploadFunctionSubscriber, pool: string, config: any) => void;
...
export declare type ValidateFunction = (listener: ListenFunctionObservable, subscriber: ValidateFunctionSubscriber, pool: string, config: any) => void;
