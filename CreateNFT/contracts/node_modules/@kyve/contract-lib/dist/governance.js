...
var Governance = /** @class */ (function () {
    function Governance(arweave, wallet) {
        this.id = constants_1.GOVERNANCE_CONTRACT_ID;
        this.client = arweave;
        this.wallet = wallet;
    }
    Governance.prototype.getState = function (useCache) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        res = _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new Error("Couldn't read state for governance (" + this.id + ") from cache.");
